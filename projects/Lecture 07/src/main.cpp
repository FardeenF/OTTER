...
//Lecture 7
#define STB_IMAGE_IMPLEMENTATION //Should only define this once (as in here)
#include <stb_image.h>

unsigned char* image;
int width, height;

void loadImage() //Pass the filepath as an argument
{
	int channels;
	...
	if (image)
		std::cout << "Image 1 loaded: " << width << " x " << height << std::endl;
	else
