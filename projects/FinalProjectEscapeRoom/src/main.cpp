...
void SwitchSound(AudioEvent& sound1, AudioEvent& sound2)
{
	if (sound1.isPlaying())
	{
		
		sound1.StopImmediately();
		sound2.Play();
...
int main() {
	...
	// Push another scope so most memory should be freed *before* we exit the app
	{
		...
		std::vector<KeyPressWatcher> keyToggles;
		{
			...
			// use std::bind
			keyToggles.emplace_back(GLFW_KEY_T, [&]() {
				
				std::cout << "HEY!" << std::endl;
				SwitchSound(AudioClip1, AudioClip2);

				//AudioClip1.StopImmediately();
				//AudioClip2.Play();
	...
	/*	#pragma region Play Clips
			if (AudioClip > 0)
			{
				if (AudioClip == 1)
					...
					AudioClip9.Play();
				else if (AudioClip == 10)
					AudioClip10.Play();
				else if (AudioClip == 11)
					AudioClip11.Play();
				else if (AudioClip == 12)
					AudioClip12.Play();
				else if (AudioClip == 13)
					AudioClip13.Play();
				else if (AudioClip == 14)
					AudioClip14.Play();
				else if (AudioClip == 15)
					AudioClip15.Play();
				else if (AudioClip == 16)
					AudioClip16.Play();
				else if (AudioClip == 17)
					AudioClip17.Play();
			}
