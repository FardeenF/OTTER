...
public:
	...
	//Sets the camera mode, perpective or orthographic
	void SetCameraMode(bool isPerpective);
...
protected:
	...
	//Check if perpective view (default view) is active
	mutable bool isPerpectiveView;
