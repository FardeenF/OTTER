...
void Camera::SetCameraMode(bool isPerpective)
{
	isPerpectiveView = isPerpective;
	__CalculateProjection();
}
...
void Camera::__CalculateProjection() {
	...
	{
		//Follows -, +, -, +
		_projection = glm::ortho(-4.0f, 4.0f, -4.0f, 4.0f, _nearPlane, _farPlane);
		_isDirty = true;
	}
}
