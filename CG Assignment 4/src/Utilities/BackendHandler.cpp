...
void BackendHandler::RenderVAO(const Shader::sptr& shader, const VertexArrayObject::sptr& vao, const glm::mat4& viewProjection, const glm::mat4& worldTransform, const glm::mat3 normalMatrix, const glm::mat4& lightSpaceMat)
{
	shader->Bind();
