...
void GBuffer::Init(unsigned width, unsigned height)
{
	...
	//Important note, you can obtain the postional data using the depth buffer (there's a calculation you can do).
	//But here, we're going to use the POSITION buffer
...
void GBuffer::DrawDepthBufferToScreen()
{
	//Binds passthrough shader
	_passThrough->Bind();
...
void GBuffer::DrawNormalBufferToScreen()
{
	//Binds passthrough shader
	_passThrough->Bind();
...
void GBuffer::DrawColorBufferToScreen()
{
	//Binds passthrough shader
	_passThrough->Bind();
